...
<header>
 ...
 <main>
	...
	<div class="container">
	  <h1>${requestScope.nombreT}</h1>
	  <br/>
	  <form action="doValidarTrivial" method="post"  >
	  	
	  	<c:forEach var="t" items="${requestScope.trivias}" varStatus="i" >
	 		<h2>${t.textoTrivial}</h2>

			<label class="form-check-label" style="width:60%">
				<input type="radio" class="form-check-input" name="inf${i.index}" value="valueA-${t.idTrivial}-${t.bloqueTrivial}" checked/>
				${t.respA}
			</label>
	
			<label class="form-check-label" style="width:60%">
				<input type="radio" class="form-check-input" name="inf${i.index}" value="valueB-${t.idTrivial}-${t.bloqueTrivial}"/>
				${t.respB}
			</label>
		
			<label class="form-check-label" style="width:60%">
				<input type="radio" class="form-check-input" name="inf${i.index}" value="valueC-${t.idTrivial}-${t.bloqueTrivial}"/>
				${t.respC}
			</label>
			
			<label class="form-check-label" style="width:100%">
			<input type="radio" class="form-check-input" name="inf${i.index}" value="valueD-${t.idTrivial}-${t.bloqueTrivial}"/>
				${t.respD}
			</label>
