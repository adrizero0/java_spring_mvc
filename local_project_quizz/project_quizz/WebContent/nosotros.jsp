        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                     <li><a href="toMenu">Ir a Home</a></li>
	...
	<div class="container">	  	
	  <h1>YipiQuizzes</h1><br/>
		...
		<div class="container-menu">
		  <a href="#" >
		  	<input type="image" src="static/Content/images/miriam.jpg" style="width:200px"/>
		  <br/>Miriam Paiz</a>		  
		</div>
		
		<div class="container-menu">
		  <a href="#" >
		  	<input type="image" src="static/Content/images/adriana.png" style="width:200px"/>
		  <br/>Adriana Pedroza</a>		  
		</div>
			
		<div class="container-menu">
		  <a href="#" >
		  	<input type="image" src="static/Content/images/jose.jpg" style="width:200px"/>
		  <br/>José Carlos Cruzado</a>		  
		</div>	  	
	 </div>
</main>
