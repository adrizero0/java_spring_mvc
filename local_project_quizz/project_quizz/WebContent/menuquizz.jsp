...
<main>
	  ...
	  <br/><br/>
	<div class="container">			
			<c:forEach var="nq" items="${requestScope.nombresquizz}" >
				<br/><br/>
				<div class="ir${nq.bloqueQuizz}">
				<a href="doPrepararQuizz?bloqueQuizz=${nq.bloqueQuizz}" class="btn btn-default btn-primary" style="width:100%" > ${nq.nombreQuizz}</a>		
				</div>	
			</c:forEach>			
		<br/><br/>
	</div>
