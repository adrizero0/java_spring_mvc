...
<header>
 ...
 <main>
	...
	<div class="container">		
		<c:forEach var="nt" items="${requestScope.nombrestrivial}" >
			<br/><br/>
			<a href="doPrepararTrivial?bloqueTrivial=${nt.bloqueTrivial}" class="btn btn-default btn-primary" style="width:100%" > ${nt.nombreTrivial}</a>
			<br/>		
		</c:forEach>	
		<br/><br/>
	</div><br/>
