...
<header>
 ...
 <main>
	...
	<div class="container">	 
		...
		<h1>Habéis obtenido: ${requestScope.puntos} puntos</h1> 
		<br/><br/>	
  		<h2>${requestScope.resultadoTrivial}</h2>
 		
		<br/><br/>	
		<h3>¡Enhorabuena ${sessionScope.user.nick}! Tienes ${sessionScope.user.points} puntos acumulados</h3>
		
	 	  
	  	<br/><br/>
	<a href="doRegresar" class="btn btn-default btn-primary" style="width:200px" >Regresa al menú</a>	  
	</div>
</main>
<!-- 	FOOTER -->
	<br/><br/>	<br/><br/>	
